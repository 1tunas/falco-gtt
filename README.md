...
Invece di aprire un'app di trasporto pubblico, puoi eseguire il comando rapido, inserire il **numero della fermata** e vedere immediatamente i **prossimi mezzi in arrivo**.
...
3. Il comando recupera e mostra:
   - i **prossimi autobus**
   - i **prossimi tram**
   - i **tempi di arrivo stimati**

È un modo rapido per controllare gli orari quando sei già in movimento.

---

## Installazione

![qr-code](https://github.com/1tunas/falco-gtt/blob/main/download-qr.png)
